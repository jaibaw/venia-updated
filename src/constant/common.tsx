...
export const CATEGORY = [
    ...
    { id: "2", img: 'https://fakestoreapi.com/img/71li-ujtlUL._AC_UX679_.jpg', name: "Shop Men" },
    { id: "3", img: 'https://fakestoreapi.com/img/71YAIFU48IL._AC_UL640_QL65_ML3_.jpg', name: "Jewellery" },
    { id: "4", img: 'https://fakestoreapi.com/img/81Zt42ioCgL._AC_SX679_.jpg', name: "Electronics" },
]
...
export const COUNTRY = [
    ...
    { id: 2, value: "United-State", label: 'United-State' },
    { id: 3, value: "United-Nation", label: 'United-Nation' },
    { id: 4, value: "France", label: 'France' },
    { id: 5, value: "Korea", label: 'Korea' },
    { id: 6, value: "Canada", label: 'Canada' },
]

export const STATE = [
    { id: 1, value: "Maharashtra", label: 'Maharashtra' },
    { id: 2, value: "Chicago", label: 'Chicago' },
    { id: 3, value: "Canada ", label: 'Canada n' },
]